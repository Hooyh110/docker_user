...
MAIL_REVIEW_SMTP_SERVER = 'smtp.qiye.aliyun.com'
MAIL_REVIEW_SMTP_PORT = 25
MAIL_REVIEW_FROM_ADDR = 'itservice@xiongmaocar.com'  # 发件人，也是登录SMTP server需要提供的用户名
MAIL_REVIEW_FROM_PASSWORD = '0cC6uYDLLLeIC4Ir'  # 发件人邮箱密码，如果为空则不需要login SMTP server
